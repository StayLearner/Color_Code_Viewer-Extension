...
//                 <span class="value hex" data-color="${color}">${color}</span>
//                 <button class="show-popup-btn" data-color="${color}" style="margin-left: 10px; padding: 5px;">Details</button>
//             </li>
//         `
//     ).join("");
...
//     const popupButtons = document.querySelectorAll(".show-popup-btn");
